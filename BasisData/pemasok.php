...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="content-2">
                <div class="payments">
                    ...
                    <table>
                        ...
                        $stid = oci_parse($koneksi, 'SELECT * FROM pemasok');
                        oci_execute($stid);
            ...
            <a href="pemasok/create.php" class="tombol">Create</a>
            <a href="pemasok/update.php" class="tombol">Update</a>
            <a href="pemasok/delete.php" class="tombol">Delete</a>
        </div>
    </div>        
</body>
</html>
